...
config = AutoConfig.from_pretrained("RaphaelMourad/Mistral-DNA-v1-17M-hg38", cache_dir=cache_directory) # Mixture of expert
...
tokenizer = AutoTokenizer.from_pretrained("RaphaelMourad/Mistral-DNA-v1-17M-hg38", trust_remote_code=True, cache_dir=cache_directory)
...
training_args = TrainingArguments(
        output_dir='./Minstral_17M/results/models',
