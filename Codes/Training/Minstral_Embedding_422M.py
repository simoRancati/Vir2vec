...
os.environ["HF_DATASETS_CACHE"] = "/blue/salemi/share/varcovid/ViralLingo/Embedding/cache_directory_M422"
import torch
import numpy as np
...
cache_directory = "/blue/salemi/share/varcovid/ViralLingo/Embedding/cache_directory/cache_directory_M422"
device = 'auto'

config = AutoConfig.from_pretrained("RaphaelMourad/Mistral-DNA-v1-422M-hg38", cache_dir=cache_directory) # Mixture of expert
...
tokenizer = AutoTokenizer.from_pretrained("RaphaelMourad/Mistral-DNA-v1-422M-hg38", trust_remote_code=True, cache_dir=cache_directory)
...
dataset = dataset_text.map(tokenize_function, batched=True,  load_from_cache_file=False, keep_in_memory=True)
...
training_args = TrainingArguments(
        output_dir='./Minstral_422M/results/models',
