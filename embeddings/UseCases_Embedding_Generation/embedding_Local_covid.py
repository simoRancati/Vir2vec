...
#############################
CSV_PATH = '/blue/simone.marini/share/Code_Mistral/covid/unique/omicron/covid.csv'
OUTPUT_DIR = '/blue/salemi/share/varcovid/ViralLingo/Embedding/UseCases/Covid_Local/embeddings_results_covid'
CHUNK_SIZE = 50
BATCH_SIZE = 4
