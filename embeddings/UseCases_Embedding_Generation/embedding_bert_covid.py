...
#############################
CSV_PATH = '/blue/simone.marini/share/UseCases/covid/covid.csv'
OUTPUT_DIR = '/blue/salemi/share/varcovid/ViralLingo/Embedding/UseCases/Covid_Bert/embeddings_results_covid'
