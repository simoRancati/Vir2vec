...
CSV_PATH   = '/blue/simone.marini/share/Code_Mistral/test_data/test_split.csv' ## qua metti quello che vuoi te
OUTPUT_DIR = Path('embeddings_results_NTtransformer'); OUTPUT_DIR.mkdir(exist_ok=True)
MODEL_ID   = '"InstaDeepAI/nucleotide-transformer-2.5b-multi-species'
FILE_OUT   = OUTPUT_DIR / 'NTtransformer_max_embeddings.h5'
BATCH_SIZE = 16
CHUNK_SIZE = 200
MAX_LEN    = 4096
USE_FP16   = False
